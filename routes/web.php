...
Route::get('/detailTuxtla', 'HomeController@detailTuxtla')->name('detail.tuxtla');
Route::post('/filterTuxtla', 'HomeController@filterTuxtla');
Route::get('/tapachula', 'HomeController@tapachula')->name('tapachula');
Route::get('/detailTapachula', 'HomeController@detailTapachula')->name('detail.tapachula');
Route::post('/filterTapachula', 'HomeController@filterTapachula');
